...
public class BooleanConditionalsLoops {
	...
	public static void main(String[] args) {
		...
		//or if thirst level is greater than 6 and prints "No Thanks" otherwise
		...
		//you will evenly distribute all of the cookies to the children and as the result
		...
		int numberOfCookies = 34;
		int numberOfChildren = 8;
		numberOfCookies = numberOfCookies % numberOfChildren; //can also put in if conditional like if (numberOfCookies % numberOfChildren >=5)
		...
		if (username == "Tommy123" && password == "12345") { //using username.equals("Tommy123") is better to use when comparing strings
		...
		for (int i = 0; i <= 100; i += 2) { //can also add an if (i % 2 ==0) for even numbers if using i++
			System.out.println(i);
		}
